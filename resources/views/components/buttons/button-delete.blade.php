...
<form method="POST" action="{{ $action }}">
    ...
    <button type="submit" value="DELETE"
        class=" glass border border-blue-600 text-base-content hover:bg-red-600 hover:text-primary-content font-medium px-4 py-2 rounded-md transition m-2 block"
